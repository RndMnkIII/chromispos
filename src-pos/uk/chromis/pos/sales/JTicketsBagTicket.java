...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private void initComponents() {
        ...
        m_jPrint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uk/chromis/images/reprint.png"))); // NOI18N
        ...
        m_jPrint1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uk/chromis/images/printer24_on.png"))); // NOI18N
        m_jPrint1.setText(AppLocal.getIntString("button.print")); // NOI18N
        m_jPrint1.setToolTipText("Imprimir Factura"); // NOI18N
        ...
        m_jPrint1.setPreferredSize(new java.awt.Dimension(50, 40));
        ...
        if (m_ticket != null) {
            try {
                ...
                switch (m_ticket.getTicketType()) {
                    case NORMAL:
                    case REFUND:
                        m_TTP2.printTicket(script.eval(m_dlSystem.getResourceAsXML("Printer.Ticket_edit")).toString());
                        //m_panelticketedit.printReport("/uk/chromis/reports/ticketsample", m_ticket, null);
                        //m_panelticketedit.printReport("/uk/chromis/reports/Factura_TPV", m_ticket, null);
                        break;
                    case INVOICE:
