...
public class TicketParser extends DefaultHandler {
    ...
    private String m_sVisorLine3;
    private String m_sVisorLine4;

    private double m_dValue1;
    private double m_dValue2;
    private double m_dValue3;
    private double m_dValue4
            ;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        switch (m_iOutputType) {
            ...
            case OUTPUT_TICKET:
                ...
                break;
            case OUTPUT_DISPLAY:
                if ("line".equals(qName)) { // line 1,2,3 or 4 of the display
                    m_sVisorLine = new StringBuilder();
                } else if ("line1".equals(qName)) { // linea 1 del visor
                    m_sVisorLine = new StringBuilder();
                } else if ("line2".equals(qName)) { // linea 2 del visor
                    m_sVisorLine = new StringBuilder();
                } else if ("line3".equals(qName)) { // linea 2 del visor
                    m_sVisorLine = new StringBuilder();
                } else if ("line4".equals(qName)) { // linea 2 del visor
                    m_sVisorLine = new StringBuilder();    
                } else if ("text".equals(qName)) {
                    text = new StringBuilder();
                    String sAlign = attributes.getValue("align");
...
// Convert entry to byte
            ...
            case OUTPUT_DISPLAY:
                if ("line".equals(qName)) { // line 1, 2 ,3  or 4 of the display
                    ...
                    } else if (m_sVisorLine2 == null){
                        m_sVisorLine2 = m_sVisorLine.toString();
                    } else if (m_sVisorLine3 == null){
                        m_sVisorLine3 = m_sVisorLine.toString();
                    } else {
                        m_sVisorLine4 = m_sVisorLine.toString();
                    }
                    m_sVisorLine = null;
                } else if ("line1".equals(qName)) { // linea 1 del visor
                    m_sVisorLine1 = m_sVisorLine.toString();
                    ...
                    m_sVisorLine2 = m_sVisorLine.toString();
                    m_sVisorLine = null;
                } else if ("line3".equals(qName)) { // linea 3 del visor
                    m_sVisorLine3 = m_sVisorLine.toString();
                    m_sVisorLine = null;
                } else if ("line4".equals(qName)) { // linea 4 del visor
                    m_sVisorLine4 = m_sVisorLine.toString();
                    m_sVisorLine = null;                    
                } else if ("text".equals(qName)) {
                    if (m_iTextLength > 0) {
                    ...
                    //Inicio RndMnkIV
                    //modicar para visualizar 4 lineas
                    //m_printer.getDeviceDisplay().writeVisor(m_iVisorAnimation, m_sVisorLine1, m_sVisorLine2);
                    if (m_sVisorLine1 == null) m_sVisorLine1="";
                    if (m_sVisorLine2 == null) m_sVisorLine2="";
                    if (m_sVisorLine3 == null) m_sVisorLine3="";
                    if (m_sVisorLine4 == null) m_sVisorLine4=""; 
                    m_printer.getDeviceDisplay().writeVisor(m_iVisorAnimation, m_sVisorLine1, m_sVisorLine2, m_sVisorLine3, m_sVisorLine4);
                    //Fin RndMnkIV
                    m_iVisorAnimation = DeviceDisplayBase.ANIMATION_NULL;
                    m_sVisorLine1 = null;
                    m_sVisorLine2 = null;
