...
public class PromotionSupport {
    ...
    public void DiscountProductPercent(TicketInfo ticket, int lineIndex,
        ...
        if (productline.isPromotionAdded() == false
            ...
            //double discount = (intPart(productline.getPrice() * discountrate)/ -100d);
            BigDecimal priceBD=new BigDecimal(String.valueOf(productline.getPrice())).setScale(8,RoundingMode.HALF_UP);
            BigDecimal discountrateBD=new BigDecimal(String.valueOf(discountrate)).setScale(8,RoundingMode.HALF_UP);
            BigDecimal factorBD=new BigDecimal("-100.0").setScale(8,RoundingMode.HALF_UP);
            
            BigDecimal discountBD=priceBD.multiply(discountrateBD).setScale(8,RoundingMode.HALF_UP);
            discountBD=discountBD.divide(factorBD, 8, RoundingMode.HALF_UP);
            ...
            TicketLineInfo discountline = new TicketLineInfo(
                    ...
                    discountBD.setScale(8,RoundingMode.HALF_UP).doubleValue(),
    ...
    public void DiscountProductQty(TicketInfo ticket, int lineIndex,
        ...
        if (productline.isPromotionAdded() == false
            ...
            //modificado por RndMnkIV
            setPrice=Math.rint(setPrice * 1000000.0)/1000000.0;
