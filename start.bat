...
start  javaw -cp %CP% -Djava.library.path="%DIRNAME%lib/Windows/i368-mingw64" -Ddirname.path="%DIRNAME%./" -splash:chromis_splash.png uk.chromis.pos.forms.StartPOS %11