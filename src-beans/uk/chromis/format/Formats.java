...
public abstract class Formats {
    ...
    private static final class FormatsDOUBLE extends Formats {
        ...
        @Override
        protected String formatValueInt(Object value) {
            m_doubleformat.setRoundingMode(RoundingMode.HALF_UP);
            //return m_doubleformat.format(DoubleUtils.fixDecimals((Number) value)); // quickfix for 3838
            return m_doubleformat.format((Number) value);
        }
    ...
    private static final class FormatsCURRENCY extends Formats {
        ...
        @Override
        protected String formatValueInt(Object value) {
            //Double depura=new Double("5000.0");
            //depura = depura + (Double) value;
            BigDecimal depuraBD;
            depuraBD = new BigDecimal(String.valueOf(value));
            depuraBD.setScale(2,RoundingMode.HALF_UP);
            //depuraBD.doubleValue();
            m_currencyformat.setRoundingMode(RoundingMode.HALF_UP);
            //return m_currencyformat.format(DoubleUtils.fixDecimals((Number) value)); // quickfix for 3838
            return m_currencyformat.format(depuraBD.doubleValue()); // quickfix for 3838
        }
